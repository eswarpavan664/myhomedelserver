...
app.get('/sendOrderAsSms',async (req,res)=>{
   ...
   var options = {authorization :'w1kvUyI2XKeQLoNzOqr9TAJgihZ4tRfMFpnx7dlbBjHCuYG6aPh0jLoXTaZyRtEpwIbQzrKdH8xMP2cl' , message : 'Customer:- '+customername+'\t Mobile No:-'+phonenumber+' with Order Id:-'+orderid ,  numbers : ['8374174776']} 
